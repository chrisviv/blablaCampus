...
<div class="boxBookValidate">
    <p> Bonjour <span> Alain </span></p>
    <p>Je t’informe qu’une place t’attend dans ma voiture <br> pour le trajet <span> Dole - Lons le Saunier.</span></p>
    <p>A bientot.</p>
</div>
</div>
<div class="bookValidateBtn" id="bookValidateBtn">
    <a href="list.php">
