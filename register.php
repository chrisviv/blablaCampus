    ...
    <div class="mainRegister">
        <div class="headerRegister">
            <div class="headerLogo">
                <img src="assets/img/bbcLogo.svg" alt="">
            </div>
        ...
        <div class="registerContent">
            <form action="" method="" class="formRegister">
                ...
                <input class="ipRegister" type="text" placeholder="Nom">
                <input class="ipRegister" type="text" placeholder="Nom d'utilisateur">

                <h2>ENTREZ VOTRE MOT DE PASSE</h2>
                <input class="ipRegister" type="password" placeholder="Mot de passe">

                <h2>ENTREZ VOTRE EMAIL</h2>
                <input class="ipRegister" type="email" placeholder="Email">
                ...
                <textarea class="txtRegister" type="text" placeholder="Entrez votre bio ici"></textarea>
                ...
                <input class='submit' type="submit" name="" value="CRÉER UN COMPTE">
            </form>
        </div>
